...
class ComposerStaticInitd1e1161b25e0617b83910a59deb374e2
{
    ...
    public static $classMap = array (
        ...
        'PluginAuditor\\Admin' => __DIR__ . '/../..' . '/includes/class-admin.php',
        'PluginAuditor\\Ajax' => __DIR__ . '/../..' . '/includes/class-ajax.php',
        'PluginAuditor\\CheckSettings' => __DIR__ . '/../..' . '/includes/class-check-settings.php',
        'PluginAuditor\\Cpt' => __DIR__ . '/../..' . '/includes/class-cpt.php',
        'PluginAuditor\\FileCollector' => __DIR__ . '/../..' . '/includes/class-file-collector.php',
        'PluginAuditor\\Modal' => __DIR__ . '/../..' . '/includes/class-modal.php',
        'PluginAuditor\\PluginValidator' => __DIR__ . '/../..' . '/includes/class-plugin-validator.php',
        'PluginAuditor\\RateLimiter' => __DIR__ . '/../..' . '/includes/class-rate-limiter.php',
        'PluginAuditor\\Report' => __DIR__ . '/../..' . '/includes/class-report.php',
        'PluginAuditor\\ReportRenderer' => __DIR__ . '/../..' . '/includes/class-report-renderer.php',
        'PluginAuditor\\ReportRepository' => __DIR__ . '/../..' . '/includes/class-report-repository.php',
        'PluginAuditor\\Scanner' => __DIR__ . '/../..' . '/includes/class-scanner.php',
        'PluginAuditor\\ScoreCalculator' => __DIR__ . '/../..' . '/includes/class-score-calculator.php',
        'PluginAuditor\\Tests\\Unit\\CheckSettingsTest' => __DIR__ . '/../..' . '/tests/Unit/CheckSettingsTest.php',
        'PluginAuditor\\Tests\\Unit\\ReportTest' => __DIR__ . '/../..' . '/tests/Unit/ReportTest.php',
        'PluginAuditor\\Tests\\Unit\\ScannerTest' => __DIR__ . '/../..' . '/tests/Unit/ScannerTest.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitd1e1161b25e0617b83910a59deb374e2::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitd1e1161b25e0617b83910a59deb374e2::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitd1e1161b25e0617b83910a59deb374e2::$classMap;
